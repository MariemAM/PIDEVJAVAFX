...
public class TableController implements Initializable {
    ...
    @FXML
    private TableColumn<pidev.entities.Promotion, String> col_datefin;
    @FXML
    private TableColumn<pidev.entities.Promotion, String> col_taux;
    @FXML
    private TableColumn<pidev.entities.Promotion, String> col_action;
    @FXML
    ...
    private void add_promo(MouseEvent event) throws IOException {
        AnchorPane pane1 = FXMLLoader.load(getClass().getResource("addPromo.fxml"));
        root.getChildren().setAll(pane1);
